...
static bool testAvlJoinTrees(){
	...
	AvlTree<keyTest, DataTest,Compare<keyTest> > avl_7 = avl_1;
	avl_7.printAvl();
	...
	AvlTree<keyTest, DataTest,Compare<keyTest> > avl_8(cmp);
	...
	AvlTree<keyTest, DataTest,Compare<keyTest> > avl_10(avl_9, avl_8);
	avl_10.printAvl();
	avl_9.printAvl();
